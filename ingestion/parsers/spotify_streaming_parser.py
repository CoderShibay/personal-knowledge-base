...
def parse_spotify_streaming(spotify_path=SPOTIFY_PATH):
    chunks = []
    ...
    print(f"Scanning Spotify streaming history: {spotify_path}")
...
if __name__ == "__main__":
    chunks = parse_spotify_streaming()
